...
<head>
    ...
    <title>طلب جهاز الحاسوب والطابعات ومداد الطابعات والات التصوير</title>
</head>
<style>
    .title{
        font-size: 16px;
...
<p class="part2 title">        <span  >وزارة العدل </span>
        ...
        <p  class="part4 title">المديرية الفرعية الاقليمية</p>
            ...
            <div style="position: relative">
                ...
                <h1 style="text-align: center ;padding-top:200px;">طلب جهاز الحاسوب والطابعات ومداد الطابعات والات التصوير<br><h2 style="text-align: center">{{ $request->id }} :رقم</h2></h1>
...
<thead>
<tr>    <th style="width: 40%">دواعي الاستعمال</th><th style="width: 10%"> الكمية المطلوبة</th><th style="width: 42%">تعيين الاشياء </th><th style="width: 8%"> الرقم</th>
</tr></thead>
<tbody>
    @foreach ($deviceType as $dev)
    <tr>
        <td style="text-align: right">{{ $request->why }}</td>
        <td style="text-align: right">{{ $deviceNumber[$loop->index] }}</td>
