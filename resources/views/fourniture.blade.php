...
<body>
    ...
    <div class="addMessage hh">
        ...
        <div class="formSection">
            <h1>ملئ طلب أدوات المكتب</h1>
            
            <span style="font-size: 12px">(*) يجب ملء الخانات التي تحتوي على</span>
            <form action='{{ route('fourniture.send') }}' method="POST">
                @csrf


                <div class="inputLabel">                     
                  <input type="hidden" name="typeF" value="" id="type">                   
                  <select name="" id="rara" multiple multiselect-search="true" multiselect-select-all="true" onchange="showR()" style="border: 1px solid red"
                    <option value="حاسوب">حاسوب</option>
                    <option value="لوحة المفاتيح">لوحة المفاتيح</option>
                    <option value="الفأرة">الفأرة</option>
                    ...
                    <option value="كاميرا ويب">كاميرا ويب</option>
                    <option value="مودم">مودم</option>
                    <option value="كرت شبكة">كرت شبكة</option>
                    <option value="أقلام رصاص">أقلام رصاص</option>
                    <option value="أوراق">أوراق</option>
                    <option value="ممحاة">ممحاة</option>
                  </select>
                  <label for="" class="input-label" id="select" style="top: 0; background: white; padding: 0 5px; color: green"><span>*  </span>نوعية الأداة المطلوبة</label>
              </div>
              ...
              <div class="inputLabel inputContainer">
                ...
                <div class="inputLabel">
                    <input type="text" id="a" class="input-field @if($errors->has('why')) errorInput @endif" name="why" onchange="handleCheck('a', 'z')">
                    <label for="" class="input-label" id="z"><span>*  </span>دواعي الإستعمال</label>
                </div>
