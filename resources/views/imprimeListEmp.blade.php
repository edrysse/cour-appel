...
<body>
    <div class="listMessages-section">
        ...
        <div class="searchResultWaiting">
            <p>تمكنكم هذه الواجهة من الإطلاع على طلبات المطبوعات الخاصة بك<br><span>.واجهة خاصة بالموظفين تحت مسمى وظيفي موظف</span></p>
          </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.title = 'نافذة الحق' + ' - ' + 'قائمة طلبات المطبوعات';
    });
  </script>
    <x-foo_ter/>
